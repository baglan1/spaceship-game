...
public class VolumetricComponent : ExploderComponent {
	...
	private void initParticleSystem() {
		var mainParticle = GetComponent<ParticleSystem>().main;
		mainParticle.maxParticles = maxParticles;
		...
		var startSize = mainParticle.startSize;
		startSize.curveMultiplier = 1f;
		var startLifeTime = mainParticle.startLifetime;
		startLifeTime.constant = duration;
